...
// [name, role, heightCm, ratings[25], abilityMask, extras[3], hand, look[skin,hair,style]]
export type DbPlayer = [string, string, number, number[], number, number[], string, [number, number, number]];
